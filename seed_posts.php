...
$posts_data = array(
    ...
    array(
        ...
        'excerpt' => 'Tháng 06/2026 đánh dấu những bước chuyển mình quan trọng của Trường Cao đẳng Công nghệ Thủ Đức trong việc nâng tầm chất lượng giảng dạy, kết nối hợp tác doanh nghiệp và lan tỏa tinh thần trách nhiệm cộng đồng. Nhà trường đã tổ chức nhiều hội thảo chuyên đề, ký kết biên bản ghi nhớ hợp tác với các doanh nghiệp công nghệ hàng đầu, đồng thời triển khai các chương trình đào tạo kỹ năng số cho sinh viên.',
        'content' => 'Tháng 06/2026 đánh dấu những bước chuyển mình quan trọng của Trường Cao đẳng Công nghệ Thủ Đức trong việc nâng tầm chất lượng giảng dạy, kết nối hợp tác doanh nghiệp và lan tỏa tinh thần trách nhiệm cộng đồng. Nhà trường đã tổ chức nhiều hội thảo chuyên đề, ký kết biên bản ghi nhớ hợp tác với các doanh nghiệp công nghệ hàng đầu, đồng thời triển khai các chương trình đào tạo kỹ năng số cho sinh viên.',
    ...
    array(
        ...
        'excerpt' => 'Sáng ngày 13/07/2026, Trường Cao đẳng Công nghệ Thủ Đức đã long trọng tổ chức lễ công bố và đón nhận Giấy chứng nhận đạt chuẩn kiểm định chất lượng giáo dục nghề nghiệp cho ngành Công nghệ thông tin trình độ cao đẳng. Đây là kết quả của nhiều năm nỗ lực không ngừng trong việc cải tiến chương trình đào tạo, nâng cao trình độ đội ngũ giảng viên và đầu tư cơ sở vật chất hiện đại.',
        'content' => 'Sáng ngày 13/07/2026, Trường Cao đẳng Công nghệ Thủ Đức đã long trọng tổ chức lễ công bố và đón nhận Giấy chứng nhận đạt chuẩn kiểm định chất lượng giáo dục nghề nghiệp cho ngành Công nghệ thông tin trình độ cao đẳng. Đây là kết quả của nhiều năm nỗ lực không ngừng trong việc cải tiến chương trình đào tạo, nâng cao trình độ đội ngũ giảng viên và đầu tư cơ sở vật chất hiện đại.',
    ...
    array(
        ...
        'excerpt' => 'Nhằm lan tỏa phong trào học tập và làm theo tư tưởng, đạo đức, phong cách Hồ Chí Minh, thư viện nhà trường trân trọng giới thiệu Tủ sách điện tử Chủ tịch Hồ Chí Minh - nguồn tư liệu số phong phú và quý giá dành cho cán bộ, giảng viên và sinh viên. Tủ sách gồm hơn 200 đầu sách, bài viết, tài liệu về cuộc đời, sự nghiệp và tư tưởng của Chủ tịch Hồ Chí Minh, có thể truy cập mọi lúc, mọi nơi qua thiết bị di động.',
        'content' => 'Nhằm lan tỏa phong trào học tập và làm theo tư tưởng, đạo đức, phong cách Hồ Chí Minh, thư viện nhà trường trân trọng giới thiệu Tủ sách điện tử Chủ tịch Hồ Chí Minh - nguồn tư liệu số phong phú và quý giá dành cho cán bộ, giảng viên và sinh viên. Tủ sách gồm hơn 200 đầu sách, bài viết, tài liệu về cuộc đời, sự nghiệp và tư tưởng của Chủ tịch Hồ Chí Minh, có thể truy cập mọi lúc, mọi nơi qua thiết bị di động.',
